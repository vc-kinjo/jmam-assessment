...
const TemplateCustomizer: React.FC<TemplateCustomizerProps> = ({
  ...
  useEffect(() => {
    if (template) {
      ...
      setProjectName(`${template.name} - ${formattedDate}`);
  ...
  const calculateEndDate = () => {
    ...
    return `${end.getFullYear()}年${String(end.getMonth() + 1).padStart(2, '0')}月${String(end.getDate()).padStart(2, '0')}日`;
  };
                    ...
                    <div className="task-properties grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          />
                          <span className="text-xs text-gray-400 whitespace-nowrap">日</span>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-1">
                          <input
                            ...
                            className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
                          />
                          <span className="text-xs text-gray-400 whitespace-nowrap">時間</span>
                        </div>
                      </div>
